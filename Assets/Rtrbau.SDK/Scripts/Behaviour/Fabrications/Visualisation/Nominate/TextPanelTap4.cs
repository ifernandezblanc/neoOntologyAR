...
namespace Rtrbau
{
    ...
    /// Add links when code has been inspired
    /// </summary>
    public class TextPanelTap4 : MonoBehaviour, IFabricationable, IVisualisable, INominatable
    {
        ...
        void Start()
        {
            ...
            {
                throw new ArgumentException("TextPanelTap4::Start: Script requires some prefabs to work.");
            }
        }
        ...
        {
            DataFacet textfacet8 = DataFormats.TextPanelTap4.formatFacets[0];
            RtrbauAttribute attribute;

            // Check data received meets fabrication requirements
            if (data.fabricationData.TryGetValue(textfacet8, out attribute))
            {
                ...
                //// UPG: TextPanelTap4 to only offer new individual to nominate
                    ...
                    if (nominatesNewReport == false)
                    {
                        ...
                        if (nominatedIndividual.Name().Contains(Parser.ParseNamingNew()))
                        {
                            ...
                            else
                            {
                                ...
                                else { throw new ArgumentException("TextPanelTap4::OnNextVisualisation: nominated individual not found"); }
                                // Assign user-reported attribute value to RtrbauElement from ElementReport through RtrbauFabrication
        ...
        public bool NominatesNewReportElement(bool reportedForced)
        {
            ...
            {
                throw new ArgumentException("TextPanelTap4::CreatesNewElementReport: this function should not be accessible before an individual is nominated.");
            }
        }
        ...
        void DestroyDestroyableNominates()
        {
            ...
            foreach (OntologyEntity destroyableNominate in destroyableNominates)
            {
                ...
                else { throw new ArgumentException("TextPanelTap4::DestroyDestroyableNominates: nominate could not be destroyed"); }
            }
        }
        #endregion PRIVATE
        ...
        public void DestroyIndividual(OntologyEntity individual)
        {
            ...
            else { throw new ArgumentException("TextPanelTap4::DestroyIndividual: Individual could be uploaded and not destroyed"); }
        }
