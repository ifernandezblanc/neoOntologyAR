...
namespace Rtrbau
{
    ...
    public static class EnvironmentFormats
    {
        ...
        public static EnvironmentFormat TextPanelTap4 = new EnvironmentFormat(RtrbauFabricationName.TextPanelTap4, EnvironmentFacets.text, EnvironmentFacets.gesturetap);
