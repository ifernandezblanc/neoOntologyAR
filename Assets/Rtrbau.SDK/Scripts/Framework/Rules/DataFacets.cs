...
namespace Rtrbau
{
    ...
    public static class DataFacets
    {
        ...
        public static DataFacetRules TextFacet7 = new DataFacetRules(All, Libraries.StateIdeal, Any, Libraries.StateLibrary, Any, null, Any, Libraries.ObjectPropertyLibrary);
        public static DataFacetRules TextFacet8 = new DataFacetRules(Any, Libraries.StateNone, Any, Libraries.StateLibrary, Any, null, Any, Libraries.ObjectPropertyLibrary);
